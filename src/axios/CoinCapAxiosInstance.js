...
const coinCapAxiosInstance = axios.create({
    baseURL: process.env.REACT_APP_AXIOS_COIN_CAP_BASE_URL || 'https://api.example.com',
 ...
 */
coinCapAxiosInstance.interceptors.response.use(
    response => {
...
export default coinCapAxiosInstance;
